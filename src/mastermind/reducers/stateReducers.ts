...
export const gameStatusReducer = (
  state: GameStatus = GAME_STATUS_INTRO,
...
export const selectedPegReducer = (
...
export const showColorPickerReducer = (
  state = false,
  action: DecoratedAction,
): boolean => {
  switch (action.type) {
...
export const isRulesHiddenReducer = (
  state = true,
  action: DecoratedAction,
): boolean => {
  switch (action.type) {
