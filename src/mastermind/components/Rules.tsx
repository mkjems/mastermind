...
const Rules = () => {
  return (
    <div>
      ...
      <p>
        The colors are drawn from a pool of 8 colors, each color can only appear
        once in the code.
      </p>
      <p>
        After each guess, you will be given feedback in the form of some red and
        white dots.
      </p>
      <div className="intro-explain">
      ...
      <p>
        A white dot means one of the colors has the right color but not the
        right position.
      </p>
      <div className="intro-explain">
      ...
      <p>
        A red dot means one of the colors has the right color and the right
        position.
      </p>
